...
|------|----------|----------|----------|--------|------|------|
| 七七仙境 | 999x | 1x | 1x | 7 | - | [詳情](https://hiddenhosts.com/server/server-a6182y) |
| 花夜仙境 | 30x | 1x | 1x | 6 | - | [詳情](https://hiddenhosts.com/server/server-guuvth) |
| AIRO | 2x | 1x | 1x | 4 | - | [詳情](https://hiddenhosts.com/server/airo) |
| 亞卡迪亞 | 250x | 1x | 1x | 3 | - | [詳情](https://hiddenhosts.com/server/server-a9vid3) |
| 星光詠嘆 | 200x | 1x | 1x | 2 | - | [詳情](https://hiddenhosts.com/server/server-d89kj4) |
| 夢憶仙境 | 50x | 1x | 1x | 2 | - | [詳情](https://hiddenhosts.com/server/server-bnez6m) |
| 樂比仙境 | 50x | 1x | 1x | 1 | - | [詳情](https://hiddenhosts.com/server/server-dtir18) |
...
1. 前往 [HiddenHosts](https://hiddenhosts.com) 註冊帳號
2. 在控制台中提交你的伺服器資料
3. 審核通過後會自動出現在本清單中
...
[HiddenHosts](https://hiddenhosts.com) 是一個遊戲私服搜尋平台，幫助玩家找到最適合的私服。

### 其他遊戲私服列表

- [Awesome Lineage Servers](https://github.com/hiddenhosts/awesome-lineage-servers) — 天堂私服列表
- [Awesome MapleStory Servers](https://github.com/hiddenhosts/awesome-maplestory-servers) — 楓之谷私服列表
...
<p align="center">
  <sub>Powered by <a href="https://hiddenhosts.com">HiddenHosts</a> | 自動更新於每日 UTC 00:00</sub>
</p>
